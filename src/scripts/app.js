...
$(function() {
    ...
    $("body").on("click", function(e) {
        ...
        if (target.hasClass("big-cal__body-cell_show-popup") || target.closest(".big-cal__body-cell_show-popup").length > 0) {
        } else if ((target.hasClass("js-calendar-big-cell") || target.closest(".js-calendar-big-cell").length > 0)) {
            hideCalcPopup();
            showPopup();
        } else {
            hideCalcPopup();
